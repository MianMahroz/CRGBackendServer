...
package com.bestercapitalmedia.chiragh.propertybrokerage;
...
@Table(catalog = "dbchiraghupdated", name = "propertybrokerage")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "TestEntities/com/bestercapitalmedia/chiragh/domain", name = "Propertybrokerage")
