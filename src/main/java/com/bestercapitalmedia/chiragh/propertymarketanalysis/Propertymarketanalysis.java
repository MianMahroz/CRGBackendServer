...
@Table(catalog = "dbchiraghupdated", name = "propertymarketanalysis")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(namespace = "TestEntities/com/bestercapitalmedia/chiragh/propertymarketanalysis", name = "Propertymarketanalysis")
